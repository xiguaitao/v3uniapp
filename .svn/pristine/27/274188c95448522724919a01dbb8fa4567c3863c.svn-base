<!-- 师傅管理 -->
<template>
    <view class='masterManagement'>
        <view class="masterManagement-content">
            <tn-form ref="formRef" :model="formData" :rules="formRules" :hide-required-asterisk="true"
                label-width="200rpx" label-position="left">
                <tn-form-item label="师傅姓名" prop="name">
                    <tn-input placeholder="请输入师傅姓名" v-model="formData.name"
        ...
        <view class="masterManagement-button">
            <view>
...
<script setup name='masterManagement'>
...
const formRules = {
    name: [
        { required: true, message: '请输入师傅姓名', trigger: ['change', 'blur'] }
    ],
    mobile: [
